...
import styles from "./AddProductList.module.scss";
            ...
            <div className={styles.active}>
                ...
                <div className={styles.contactFields}>
                    <InputSelect
                        ...
                        name="productName" />
                    <InputField value={contactEditStore.productNameField}
                    ...
                    <div className={styles.actions}>
                        <ButtonImage onClick={onClickClearFields}
                                     image={<Clear />}
                                     onlyImage={true}
                                     className={styles.iconClear}
                                     variant="clear" />
                        <ButtonImage onClick={onClickAddProduct}
                                     image={<Add />}
                                     onlyImage={true}
            ...
            <div className={styles.archive}>
                ...
                <div className={styles.contactFields}>
                    <InputSelect
                        ...
                        name="productName" />
                    <InputField value={contactEditStore.productNameFieldArchive}
                    ...
                    <TextAreaField
                        ...
                        className={styles.fieldArea} />
                    <div className={styles.actions}>
                        <ButtonImage onClick={onClickClearFieldsArchive}
                                     image={<Clear />}
                                     onlyImage={true}
                                     className={styles.iconClear}
                                     variant="clear" />
                        <ButtonImage onClick={onClickAddProductArchive}
                                     image={<Add />}
                                     onlyImage={true}
                                     className={styles.iconAdd}
                                     variant="add"
